...
<body>
  <div class="center-container">
    ...
    <c:if test="${mostrarNuevoRegistro}">
      <p><a href="ProductosController?accion=nuevo" class="nr">Nuevo Registro</a></p>
    </c:if>
        ...
        <tbody>
          <c:forEach var="producto" items="${lista}">
            <tr>
              ...
              <c:if test="${mostrarEliminar}">
                <td><a href="ProductosController?accion=eliminar&codigo=${producto.codigo}">Eliminar</a></td>
              </c:if>
            </tr>
          </c:forEach>
        </tbody>
